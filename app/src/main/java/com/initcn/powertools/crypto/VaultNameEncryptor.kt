...
object VaultNameEncryptor {
    ...
    private fun getNameKey(context: Context): SecretKeySpec {
        ...
        if (encryptedKeyBase64 != null && ivBase64 != null) {
            ...
            cipher.init(Cipher.DECRYPT_MODE, getOrCreateHardwareWrapperKey(), GCMParameterSpec(TAG_BIT_LENGTH, iv))
        ...
        prefs.edit().apply {
            putString(KEY_ENCRYPTED_NAME_KEY, Base64.encodeToString(encryptedKeyBytes, Base64.DEFAULT))
